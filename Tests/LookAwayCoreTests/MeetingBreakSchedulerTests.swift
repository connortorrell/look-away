...
struct MeetingBreakSchedulerTests {
    ...
    @Test func theWindowClosingDuringAMeetingHandsOverToTheSchedule() {
        ...
        scheduler.start()
        scheduler.hold(.meeting)
        #expect(scheduler.state == .held(dueAt: at(17 * 3_600 + 40), by: .meeting))
    ...
    @Test func aDelayTakenOnACallOutsideTheScheduleHandsOverToTheSchedule() {
        ...
        scheduler.breakNow()
        scheduler.snooze()
        #expect(scheduler.state == .held(dueAt: at(20 * 3_600 + 10), by: .meeting))
    ...
    @Test func aMeetingOutlastingTheOffHoursHoldKeepsHoldingWhenTheWindowOpens() {
        ...
        #expect(scheduler.state == .held(dueAt: at(9 * 3_600 + 100), by: .meeting))
    ...
    @Test func editingTheScheduleDuringAMeetingKeepsTheDeadline() {
        ...
        #expect(scheduler.state == .held(dueAt: at(10 * 3_600 + 100), by: .meeting))
